...
function Project() {
    return ( <div className="border-b border-neutral-900 pb-4">
        ...
        <div>{PROJECTS.map((project ,index)=>(<div key={index} className="mb-8 flex flex-wrap lg:justify-center">
            <motion.div whileInView={{opacity:1, x:0}} initial={{opacity:0, x:-100}} transition={{duration:0.5}} className="w-full lg:1/4">
            <img 
            width={150}
